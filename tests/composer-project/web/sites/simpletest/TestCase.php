        ...
        if ($this->runInSeparateProcess()) {
            ...
            if ($runEntireClass) {
                $template = new \Text_Template(
                    '/srv/http/drupal-test-runner/tests/composer-project/vendor/composer/../phpunit/phpunit/src/Util/PHP/Template/TestCaseClass.tpl'
                );
            } else {
                $template = new \Text_Template(
                    '/srv/http/drupal-test-runner/tests/composer-project/vendor/composer/../phpunit/phpunit/src/Util/PHP/Template/TestCaseMethod.tpl'
                );
            }
